<%-- 
    Document   : womenclothes3.jsp
    Created on : Dec 18, 2023, 7:52:51 AM
    Author     : SKS
--%>
...
<html>
    <head>
        ...
        <title>Women-clothes 3 Page</title><link rel="stylesheet" href="Green-supermarkect.css">
        ...
        <div class="items-view" style='padding:40px 80px;'>
            <%
                try {
                        ...
                        String str = "select clothes_id, clothes_name, prices, image_path from clothes_details where clothes_category = 3";
