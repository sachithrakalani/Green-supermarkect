<%-- 
    Document   : womenclothesdenims.jsp
        ...
        <div class="items-view" style='padding:40px 80px;'>
            <%
                try {
                        ...
                        String str = "select clothes_id, clothes_name, prices, image_path from clothes_details where clothes_category = 5";
