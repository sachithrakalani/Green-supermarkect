<%-- 
    Document   : cosmatics.jsp
    Created on : Dec 20, 2023, 12:05:54 PM
    Author     : SKS
--%>
        ...
        <div class="items-view" style='padding:40px 80px;'>
            <%
                try {
                        ...
                        String str = "select cosmetics_id, cosmetics_name, prices, image_path from cosmetics_details where cosmetics_category = 1";
                        ResultSet rs = st.executeQuery(str);
                        while (rs.next()) {
                            String itemName = rs.getString("cosmetics_name");
                            int itemPrice = rs.getInt("prices");
                            String imagePath = rs.getString("image_path");
                            String itemId = rs.getString("cosmetics_id");
                            //out.println(itemId);
...
//                            out.println("<i class='fa fa-star'></i>");
        ...
        <script>
            function redirectToItemDetails(itemId) {
                window.location.href = 'singleproductcosmetics.jsp?id=' + itemId;
            }
        </script>
    </body>
</html>
