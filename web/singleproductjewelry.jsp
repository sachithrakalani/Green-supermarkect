<%-- 
    Document   : singleproductjewelry.jsp
    Created on : Dec 20, 2023, 11:39:42 AM
    Author     : SKS
--%>
...
<html>
    <head>
        ...
        <title>Single Product Jewelry Page</title>
    ...
    <body>
        ...
        <%
            try {
                ...
                String str = "select jewelry_id, jewelry_name, prices, image_path from jewelry_details where jewelry_id= '" +itemId+ "' " ;
                ResultSet rs = st.executeQuery(str);
                while (rs.next()) {
                    String itemName = rs.getString("jewelry_name");
